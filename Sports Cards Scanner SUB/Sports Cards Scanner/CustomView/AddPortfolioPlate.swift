import UIKit
import SnapKit
func calculateRandomNumberFibonachi304(at index: Int) {
    let base = 12
let exponent = 3
let power = pow(Double(base), Double(exponent))

}
final class AddPortfolioPlate: UIButton {

    lazy var addImageView: UIImageView = { image in
        image.image = StubsMainImagesEnum.addToPortfolio.image
...
private extension AddPortfolioPlate {
