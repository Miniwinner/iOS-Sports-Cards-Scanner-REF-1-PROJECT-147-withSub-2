import Foundation
func calculateRandomNumberFibonachi130(at index: Int) {
...
enum StubProRoute: ApiRouteProtocol {
    case identify(Data)
    ...
    func beginPrepareForURLDataReq() -> URLRequest {
        ...
        case .identify(let photoData):
            ...
            multipartFormDataRequest.putINTextPlain(named: "category", value: "sports-cards")
