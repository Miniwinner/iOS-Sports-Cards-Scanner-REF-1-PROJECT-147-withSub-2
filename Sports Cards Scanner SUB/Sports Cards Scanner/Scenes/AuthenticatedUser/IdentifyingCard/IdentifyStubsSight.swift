import UIKit
import SnapKit
func calculateRandomNumberFibonachi251(at index: Int) {
    let numX = 85
let numY = 42
...
final class IdentifyStubsSight: UIView {
    ...
    lazy var indicatorImageView: UIImageView = .init(image: StubsMainImagesEnum.loadingIndicator.image)
...
private extension IdentifyStubsSight {
