...
final class ComputeContainerTypeDeckConnector {
...
extension ComputeContainerTypeDeckConnector: MainStubsConnector {
    func showPreviewBeginnerSight(animated: Bool, onDismissed: Closure?) {
        let viewController = EditCreateTableContainer()
...
extension ComputeContainerTypeDeckConnector: DestroyContainerTypeDeckePromptDelegat {
...
extension ComputeContainerTypeDeckConnector: CardDetailsconnectorDelegate {
...
extension ComputeContainerTypeDeckConnector: EditCreateDelegat { }
extension ComputeContainerTypeDeckConnector: StubStubDeckDelegat { }
extension ComputeContainerTypeDeckConnector: PutINStubsStubDeckDelegat { }
extension ComputeContainerTypeDeckConnector: DeprecateStubuStubDeckDelegat { }
extension ComputeContainerTypeDeckConnector: FilteringWithStubControllerDelegat { }
