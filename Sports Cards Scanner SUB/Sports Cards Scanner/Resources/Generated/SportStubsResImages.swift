...
internal enum StubsMainImagesEnum {
    ...
    internal enum stubsOtobrazhenie {
    ...
    internal enum MenuContainerTypeCollection {
    ...
    internal static let portfolioLocked = ImageAsset(name: "portfolioLocked")
